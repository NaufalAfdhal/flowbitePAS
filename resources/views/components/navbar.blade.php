        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="https://w7.pngwing.com/pngs/876/49/png-transparent-mercedes-benz-hd-logo.png" alt="Your Company">
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <!----Grades-->
                        <x-nav-Link href="/grade" :active="request()->is('grade')">Grades</x-nav-Link>
                        <!----department--->
